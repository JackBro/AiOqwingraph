...
#endif
{ double fval; ; assert(((( e )->sxloc) /*;void gs_ide1511 (/+D/+ e);
*/ !=(( e )->exloc) /*;void gs_ide1511 (/+D/+ e);*/ )); fval = (double)((( e )->eyloc) /*;
_ide1511 (e);*/ - (( e )->syloc) /*;_ide1511 (e);*/ )/(double)((( e )->exloc) /*;
...
ADJ+D/+ a;;*/ double fval; ; port = (( (( a )->kante) /*;t;;*/ )->weights) /*;t;;*/ ; /*;is_northeast, is_northwest;
ADJ+D/+ b;;*/  b = a; is_north = is_northeast = is_northwest = 1; while (b) { if (port!=(( (( b )->kante) /*;
double fval;;*/ )->weights) /*;double fval;;*/ ) break;  e = (( b )->kante) /*;
;;*/ ; if ((( e )->btyloc) /*;(( (( a )->kante) /+;R/SC;yy+NT )->weig;
*/ !=(( e )->syloc) /*;(( (( a )->kante) /+;R/SC;yy+NT )->weig;*/ )  fval = (double)((( e )->btxloc) /*;
b = a;;*/ - (( e )->sxloc) /*;b = a;;*/ )/ (double)((( e )->btyloc) /*;
h = is_northeast = is_northwest = 1;;*/ - (( e )->syloc) /*;h = is_northeast = is_northwest = 1;
;*/ ); else fval = (double)((( e )->bbxloc) /*;while (b) {;*/ - (( e )->sxloc) /*;
while (b) {;*/ )/ (double)((( e )->bbyloc) /*;t!=(( (( b )->kante) /+;
...
#endif
{
  ...
  while ( b )
  {
    if ( port != b->kante->weightp ) break;
    e = b->kante;

    // ig 11.10.2001: This code was obfuscated and contained bugs
    if ( e->bbyloc != e->eyloc )
      fval = (double)(e->exloc - e->bbxloc) / (double)(e->eyloc - e->bbyloc);
    else if ( e->eyloc != e->btyloc ) // added this check, ig 11.10.2001
      fval = (double)(e->exloc - e->btxloc) / (double)(e->eyloc - e->btyloc);
    else
      fval = (double)(e->exloc - e->btxloc);
