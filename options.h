...
extern int    exxdpi;
extern int    exydpi;
extern double  exscaling;
extern double  exwidth;
extern double  exheight;
extern double  exleftm;
extern double  exrightm;
extern double  extopm;
extern double  exbottomm;
extern int    exbbox;
...
extern "C" {
#endif 
extern const unsigned char origredmap[];
extern const unsigned char origgreenmap[];
extern const unsigned char origbluemap[];
